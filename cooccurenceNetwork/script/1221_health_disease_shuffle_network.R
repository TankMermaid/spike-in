...
# 
write.table(top50_plus_other,file = "../table/1221_AA_shuffle_top50_abundance.txt",sep = '\t',row.names = T,quote = F)
# write.table(aa_dis_sper_mat_top30,file = "../table/1024_AA_dis_top50_cor.txt",sep = '\t',row.names = T,quote = F)




write.table(aa_dis_sper_mat_top30,file = "../table/1221_AA_shuffle_top50_cor.txt",sep = '\t',row.names = T,quote = F)
write.table(aa_dis_sper_p_top30,file = "../table/1221_AA_shuffle_adjustedP_dis_top50.txt",sep = '\t',row.names = T,quote = F)
...
"Solirubrobacter"   ,  "Rudaibacter"     ,    "Bosea"          ,  "Lysobacter"  ,
  "Kineosporia"     ,    "Cellulomonas"      ,  "Actinosynnema" ,    
  "Reyranella"     ,     "Haliangium",        "g__Acremonium"  ,"g__Lachnella"   ,     "g__Scytalidium"   ,   "g__Magnaporthiopsis", 
"g__Podospora" ,  "g__Ophiosphaerella",      "g__Gibberella",        "g__Cladosporium",        "g__Pyrenochaetopsis",   "g__Bipolaris"   ,     "g__Mycosphaerella" ,  "g__Didymella"
...
# 
write.table(top50_plus_other,file = "../table/1221_RA_shuffle_top50_abundance.txt",sep = '\t',row.names = T,quote = F)

write.table(ra_dis_sper_mat_top30,file = "../table/1221_RA_shuffle_top50_cor.txt",sep = '\t',row.names = T,quote = F)
write.table(ra_dis_sper_p_top30,file = "../table/1221_RA_shuffle_adjustedP_dis_top50.txt",sep = '\t',row.names = T,quote = F)
...
ids_m_RA=a_dis[rownames(a_dis)%in% rownames(ids_p),colnames(a_dis)%in% rownames(ids_p)]



write.table(ids_m_RA,file = "../table/1221_RA_shuffleinteractionWIthBipolaris_dis.txt",sep = '\t',row.names = T,quote = F)
write.table(ids_p,file = "../table/1221_RA_shuffleinteractionWIthBipolaris_adjustedP_dis.txt",sep = '\t',row.names = T,quote = F)
