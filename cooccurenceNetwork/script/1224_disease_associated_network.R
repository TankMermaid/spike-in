...
write.table(merge_bac_fungi,file = "../table/1221_aa_adjusted_bacAndFungiMerge_abundance_diseaseHealthShuffle.txt",sep = '\t',row.names = T,quote = F)
...
write.table(top50_cor_micload_pearson$p,file = "../table/1221_AA_shuffle_top50_cor_micload_pearson_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_pearson$r,file = "../table/1221_AA_shuffle_top50_cor_micload_pearson_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
write.table(top50_cor_micload_spearman$p,file = "../table/1221_AA_shuffle_top50_cor_micload_spearman_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_spearman$r,file = "../table/1221_AA_shuffle_top50_cor_micload_spearman_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
top50_cor_micload_pearson$p
top50_cor_micload_pearson$r
write.table(top50_cor_micload_pearson$p,file = "../table/1221_AA_shuffle_g__Bipolaris_cor_micload_pearson_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_pearson$r,file = "../table/1221_AA_shuffle_g__Bipolaris_cor_micload_pearson_coreffi.txt",sep = '\t',row.names = T,quote = F)

top50_cor_micload_pearson<- corr.test(aa_dis_a[,c(idd)],dis_micload,use = "complete",method="spearman",adjust = "fdr",alpha = .05)
top50_cor_micload_pearson$p
top50_cor_micload_pearson$r
write.table(top50_cor_micload_pearson$p,file = "../table/1221_AA_shuffle_g__Bipolaris_cor_micload_spearman_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_pearson$r,file = "../table/1221_AA_shuffle_g__Bipolaris_cor_micload_spearman_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
top50_cor_micload_spearman$p
top50_cor_micload_spearman$r
write.table(top50_cor_micload_spearman$p,file = "../table/1221_AA_shuffle_Actinosynnema_cor_micload_pearson_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_spearman$r,file = "../table/1221_AA_shuffle_Actinosynnema_cor_micload_pearson_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
top50_cor_micload_spearman$p
top50_cor_micload_spearman$r
write.table(top50_cor_micload_spearman$p,file = "../table/1221_AA_shuffle_Actinosynnema_cor_micload_spearman_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_spearman$r,file = "../table/1221_AA_shuffle_Actinosynnema_cor_micload_spearman_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
write.table(ids_m,file = "../table/1221_AA_shuffle_AAinteractionWIthBipolaris_dis.txt",sep = '\t',row.names = T,quote = F)
write.table(ids_p,file = "../table/1221_AA_shuffle_AAinteractionWIthBipolaris_adjustedP_dis.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_plus_other,file = "../table/1224_AA_shuffle_bipolaris-associated_abundance.txt",sep = '\t',row.names = T,quote = F)
# write.table(aa_dis_sper_mat_top30,file = "../table/1224_AA_shuffle_bipolaris-associated_cor.txt",sep = '\t',row.names = T,quote = F)




write.table(aa_dis_sper_mat_top30,file = "../table/1224_AA_shuffle_bipolaris-associated_cor.txt",sep = '\t',row.names = T,quote = F)
write.table(aa_dis_sper_p_top30,file = "../table/1224_AA_shuffle_bipolaris-associated_adjustedP.txt",sep = '\t',row.names = T,quote = F)
...
write.table(aa_44_genus,file = "../table/1224_AA_shuffle_disease-associated_44Genus.txt",sep = '\t',row.names = T,quote = F)
...
pdf(file ="../plot/rootDisease/1224_shuffle_AA_sper_mat_top50_order_upper_1030.pdf" )
...
pdf(file ="../plot/rootDisease/1221_shuffle_AA_sper_mat_top50_order_upper_0.01.pdf" )
corrplot(aa_dis_sper_mat_top30,p.mat = aa_dis_sper_p_top30, sig.level = .01,
         insig = "blank", addrect = 2,type = "upper",diag = F,
         tl.col = "black",tl.cex = 0.75,
         cl.pos = "b",cl.length = 11,cl.align.text = "l",
...
pdf(file ="../plot/rootDisease/1221_shuffle_AA_sper_mat_top50_order_upper_p_value_0.05.pdf" )
...
pdf(file ="../plot/rootDisease/1221_shuffle_AA_sper_mat_top50_order_upper_p_value_0.001.pdf" )
corrplot(aa_dis_sper_mat_top30,p.mat = aa_dis_sper_p_top30, sig.level = .001,
         insig = "blank", addrect = 2,type = "upper",diag = F,
         tl.col = "black",tl.cex = 0.75,
         cl.pos = "b",cl.length = 11,cl.align.text = "l",
...
top50_cor_micload_pearson$p
top50_cor_micload_pearson$r
write.table(top50_cor_micload_pearson$p,file = "../table/1224_AA_shuffle_disease-associated_cor_micload_pearson_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_pearson$r,file = "../table/1224_AA_shuffle_disease-associated_cor_micload_pearson_coreffi.txt",sep = '\t',row.names = T,quote = F)

top50_cor_micload_spearman<- corr.test(aa_dis_a[,ids],dis_micload,use = "complete",method="spearman",adjust = "fdr",alpha = .05)
top50_cor_micload_spearman$p
top50_cor_micload_spearman$r
write.table(top50_cor_micload_spearman$p,file = "../table/1224_AA_shuffle_disease-associated_cor_micload_spearman_pvalue.txt",sep = '\t',row.names = T,quote = F)
write.table(top50_cor_micload_spearman$r,file = "../table/1224_AA_shuffle_disease-associated_cor_micload_spearman_coreffi.txt",sep = '\t',row.names = T,quote = F)
...
merge_bac_fungi$ID <- rownames(merge_bac_fungi)
merge_abun_tax<- merge(merge_bac_fungi,tax_merge_bac_fungi,by = "ID")
write.table(merge_bac_fungi,file = "../table/1221_shuffle_RA_adjusted_bacAndFungiMerge_abundance_disease.txt",sep = '\t',row.names = T,quote = F)
...
# 
write.table(top50_plus_other,file = "../table/1224_RA_shuffle_top50_abundance.txt",sep = '\t',row.names = T,quote = F)

write.table(ra_dis_sper_mat_top30,file = "../table/1224_RA_shuffle_top50_cor.txt",sep = '\t',row.names = T,quote = F)
write.table(ra_dis_sper_p_top30,file = "../table/1224_RA_shuffle_adjustedP_dis_top50.txt",sep = '\t',row.names = T,quote = F)
...
pdf(file ="../plot/rootDisease/1224_RA_shuffle_sper_mat_top50_upper_1030.pdf" )
...
pdf(file ="../plot/rootDisease/1221_RA_shuffle_sper_mat_top50_upper_pvalue0.01.pdf" )
...
pdf(file ="../plot/rootDisease/1221_RA_shuffle_sper_mat_top50_upper_pvalue0.05.pdf" )
...
pdf(file ="../plot/rootDisease/1221_RA_shuffle_sper_mat_top50_upper_pvalue0.001.pdf" )
