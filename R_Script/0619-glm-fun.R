...
spike <- read.csv("table/20180619-glm-fun.csv", header = T)
...
ggsave(paste("figure/20180619-fun-glm-log10.pdf", sep=""), p1, width = 7, height = 6)
...
ggsave(paste("figure/20180619-fun-glm-log2.pdf", sep=""), p2, width = 7, height = 6)
