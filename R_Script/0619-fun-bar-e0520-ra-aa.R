...
## fungi ra e05-20 group1 & group2

rawtable1 <- read.csv("table/20180619-fun-ra-e0520-group1-2.csv", header = T)
...
ggsave(paste("figure/20180619-fun-ra-e0520-group1-2.pdf", sep=""), boxplot1, width = 3, height = 4)

## fungi ra e05-20 group2 & group3

rawtable2 <- read.csv("table/20180619-fun-ra-e0520-group2-3.csv", header = T)
...
ggsave(paste("figure/20180619-fun-ra-e0520-group2-3.pdf", sep=""), boxplot2, width = 3, height = 4)



## fungi aa e05-20 group1 & group2

rawtable3 <- read.csv("table/20180619-fun-aa-e0520-group1-2.csv", header = T)
...
ggsave(paste("figure/20180619-fun-aa-e0520-group1-2.pdf", sep=""), boxplot3, width = 3, height = 4)


## fungi aa e05-20 group2 & group3

rawtable4 <- read.csv("table/20180619-fun-aa-e0520-group2-3.csv", header = T)
...
ggsave(paste("figure/20180619-fun-aa-e0520-group2-3.pdf", sep=""), boxplot4, width = 3, height = 4)
