...
data_ra <- read.csv("table/20180724-otu-bar-ra.csv", header = T)
data_aa <- read.csv("table/20180724-otu-bar-aa.csv", header = T)
...
p1 <- ggplot(data1) +
  ...
  theme_bw()
p1
ggsave(paste("figure/20180724-otus-11-ra.pdf", sep=""), p1, width = 4, height = 5)
...
p2 <- ggplot(data2) +
  ...
  theme_bw()
p2
ggsave(paste("figure/20180724-otus-16-ra.pdf", sep=""), p2, width = 4, height = 5)
...
p3 <- ggplot(data3) +
  ...
  theme_bw()
p3
ggsave(paste("figure/20180724-otus-13-ra.pdf", sep=""), p3, width = 4, height = 5)
...
p4 <- ggplot(data4) +
  ...
  theme_bw()
p4
ggsave(paste("figure/20180724-otus-11-aa.pdf", sep=""), p4, width = 4, height = 5)
...
p5 <- ggplot(data5) +
  ...
  theme_bw()
p5
ggsave(paste("figure/20180724-otus-16-aa.pdf", sep=""), p5, width = 4, height = 5)
...
p6 <- ggplot(data5) +
  ...
  theme_bw()
p6
ggsave(paste("figure/20180724-otus-13-aa.pdf", sep=""), p6, width = 4, height = 5)
...
p7 <- ggplot(data7) +
  ...
  theme_bw()
p7
ggsave(paste("figure/20180724-otus-12-ra.pdf", sep=""), p7, width = 4, height = 5)
...
p8 <- ggplot(data8) +
  ...
  theme_bw()
p8
ggsave(paste("figure/20180724-otus-20-ra.pdf", sep=""), p8, width = 4, height = 5)
...
p9 <- ggplot(data9) +
  ...
  theme_bw()
p9
ggsave(paste("figure/20180724-otus-12-aa.pdf", sep=""), p9, width = 4, height = 5)
...
p10 <- ggplot(data10) +
  ...
  theme_bw()
p10
ggsave(paste("figure/20180724-otus-20-aa.pdf", sep=""), p10, width = 4, height = 5)
