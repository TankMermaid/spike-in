...
rawtable1 <- read.csv("table/20180503-e0520-ra-group2-3.csv", header = T)
...
ggsave(paste("figure/20180503-e0520-ra-group2-3.pdf", sep=""), boxplot1, width = 6, height = 5)

## bacteria ra e05-20 group1 & group2

rawtable2 <- read.csv("table/20180503-bac-e0520-ra-group2-1.csv", header = T)
...
ggsave(paste("figure/20180503-e0520-ra-group2-1.pdf", sep=""), boxplot2, width = 6, height = 5)


## bacteria aa e05-20 group2 & group3

rawtable3 <- read.csv("table/20180503-e0520-aa-group2-3.csv", header = T)
...
ggsave(paste("figure/20180503-e0520-aa-group2-3.pdf", sep=""), boxplot3, width = 6, height = 5)


## bacteria aa e05-20 group1 & group3

rawtable4 <- read.csv("table/20180503-bac-e0520-aa-group2-1.csv", header = T)
...
ggsave(paste("figure/20180503-e0520-aa-group2-1.pdf", sep=""), boxplot4, width = 6, height = 5)
