...
bac <- read.csv("table/20180807-fig4-lm-bac.csv", header = T)
fun <- read.csv("table/20180807-fig4-lm-fun.csv", header = T)

## Bacteria E05-E00

data_e05_bac <- select(bac, OTUID, E05_bac, E00_bac)
...
data_e05_fun <- select(fun, OTUID, E05_fun, E00_fun)
...
data_e04_fun <- select(fun, OTUID, E04_fun, E00_fun)
