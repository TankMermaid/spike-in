...
for(m in method){
	# 读取usearch beta文件
	beta = read.table(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/",m,".txt",sep=""), header=T, row.names=1, sep="\t", comment.char="") 
	write.table(paste("#Permutational Multivariate Analysis of Variance Using Distance Matrices\nDistanceMatrices\tGroupA\tGroupB\tP-value",  sep=""), 
				file=paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".stat", sep=""), append = F, sep="\t", quote=F, row.names=F, col.names=F)
	...
	write.table("Samples\t", file=paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "14.txt",sep = ""), append = F, sep="\t", quote=F,  eol = "",row.names=F, col.names=F)
	suppressWarnings(write.table(points[,c(1:4)], file=paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "14.txt",sep = ""), append = T, sep="\t", quote=F, row.names=T, col.names=T))
	...
	p
	# 保存pdf和png格式方便查看和编辑
	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".pdf", sep=""), p, width = 8, height = 5)
	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".png", sep=""), p, width = 8, height = 5)
	# 提示工作完成
	print(paste("Output in /mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".pdf finished.", sep = ""))
	...
	# 保存pdf和png格式方便查看和编辑
	# 保存pdf和png格式方便查看和编辑
	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_label.pdf", sep=""), p, width = 8, height = 5)
#	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_label.png", sep=""), p, width = 8, height = 5)
	# 提示工作完成
	print(paste("Output in /mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_label.pdf finished.", sep = ""))
	...
	p
	# 保存pdf和png格式方便查看和编辑
	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_34.pdf", sep=""), p, width = 8, height = 5)
#	ggsave(paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_34.png", sep=""), p, width = 8, height = 5)
	# 提示工作完成
	print(paste("Output in /mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, "_34.pdf finished.", sep = ""))

	# 循环统计各比较组或所有组 loop for each group pair
	dis_table = as.matrix(sub_beta)
	# 如果没有比较文件，则自动全循环
	if (!file.exists("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/doc/compare.txt")) {
...
#				print(tmp_compare)
				...
				write.table(adonis_pvalue, file=paste("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".stat", sep=""), append = TRUE, sep="\t", quote=F, row.names=F, col.names=F)
			}
		}
	# 有比较文件，按设计比较
	}else {
		compare_data = read.table("/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/doc/compare.txt", sep="\t", check.names=F, quote='', comment.char="")
	...
	print(paste("Adnois statistics result in ", "/mnt/bai/xiaoning/xiaoxuan/180528/180627_AQ/bac/unoise/result/beta/", m, ".stat\n is finished.", sep = ""))
	print("")
}
