...
write.table(HA_Kingdom, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/k.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Phylum, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/p.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Class, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/c.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Order, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/o.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Family, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/f.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Genus, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/g.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(HA_Species, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/s.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
...
write.table(all, file="/mnt/bai/yongxin/other/guoxiaoxuan/180627_AQ/bac/RA/a.txt", append = FALSE, sep="\t", quote=F, row.names=F, col.names=T)
