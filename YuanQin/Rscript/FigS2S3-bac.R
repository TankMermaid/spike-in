...
ra<- read.csv("data/FigS2S3-ra.csv", header = T)
aa<- read.csv("data/FigS2S3-aa.csv", header = T)
...
ggsave(paste("result/FigS2-ra.pdf", sep=""), boxplot1, width = 9, height = 5)
...
ggsave(paste("result/FigS3-ra.pdf", sep=""), boxplot2, width = 9, height = 5)
...
ggsave(paste("result/FigS2-aa.pdf", sep=""), boxplot3, width = 9, height = 5)
...
ggsave(paste("result/FigS3-aa.pdf", sep=""), boxplot4, width =9, height = 5)
