...
ra<- read.csv("data/Fig3c3d-ra-fun-e0520.csv", header = T)
aa<- read.csv("data/Fig3c3d-aa-fun-e0520.csv", header = T)
...
ggsave(paste("result/Fig3c-ra.pdf", sep=""), boxplot1, width = 3, height = 4)
...
ggsave(paste("result/Fig3d-ra.pdf", sep=""), boxplot2, width = 6, height = 5)
...
ggsave(paste("result/Fig3c-aa.pdf", sep=""), boxplot3, width = 6, height = 5)
...
boxplot4 <- ggplot(aatable2) +
  ...
  theme(axis.text.x = element_text(angle = -45, vjust = 1, hjust = 0))
boxplot4
ggsave(paste("result/Fig3d-aa.pdf", sep=""), boxplot3, width = 6, height = 5)
