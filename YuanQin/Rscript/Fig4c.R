...
ggsave(paste("result/Fig4c-bac-ra-e05.pdf", sep=""), p1, width = 6.5, height = 6)


## E04-BAC-RA

t2 <- dplyr::select(bac, Bac, E04_RA_ONE, E04_RA_TWO)
...
ggsave(paste("result/Fig4c-bac-ra-e04.pdf", sep=""), p2 , width = 6.5, height = 6)


## E03-BAC-RA

t3 <- dplyr::select(bac, Bac, E03_RA_ONE, E03_RA_TWO)
...
ggsave(paste("result/Fig4c-bac-ra-e03.pdf", sep=""), p3 , width = 6.5, height = 6)
...
ggsave(paste("result/Fig4c-bac-qa-e05.pdf", sep=""), p4, width = 6.5, height = 6)


## E04-BAC-QA

t5 <- dplyr::select(bac, Bac, E04_QA_ONE, E04_QA_TWO)
...
ggsave(paste("result/Fig4c-bac-qa-e04.pdf", sep=""), p5, width = 6.5, height = 6)


## E03-BAC-QA

t6 <- dplyr::select(bac, Bac, E03_QA_ONE, E03_QA_TWO)
...
ggsave(paste("result/Fig4c-bac-qa-e03.pdf", sep=""), p6, width = 6.5, height = 6)
...
ggsave(paste("result/Fig4c-fun-ra-e05.pdf", sep=""), fp1, width = 6.5, height = 6)


## E03-FUN-RA

f2 <- dplyr::select(fun, FUN, E03_RA_ONE, E03_RA_TWO)
...
fp2 = ggplot(fun03ra, aes(x=variable, y = count, fill = FUN )) + 
  ...
  theme_classic()
fp2
ggsave(paste("result/Fig4c-fun-ra-e03.pdf", sep=""), fp2, width = 6.5, height = 6)
...
ggsave(paste("result/Fig4c-fun-qa-e05.pdf", sep=""), fp3, width = 6.5, height = 6)



## E03-FUN-QA

f4 <- dplyr::select(fun, FUN, E03_QA_ONE, E03_QA_TWO)
...
ggsave(paste("result/Fig4c-fun-qa-e03.pdf", sep=""), fp4, width = 6.5, height = 6)


## E03-FUN-QA-POINT

f5 <- dplyr::select(fun2, FUN, E03_QA_ONE, E03_QA_TWO)
...
ggsave(paste("result/Fig4c-fun-qa-e03-point.pdf", sep=""), fp5, width = 6.5, height = 6)
