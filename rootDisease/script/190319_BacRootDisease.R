...
setwd("~/xiaoxuan/180724/TARDB28/script/")
...
figures.dir <- paste0("~/xiaoxuan/180724/TARDB28/",.meth,'/',"plot/",sep = '')
table.dir   <- paste0("~/xiaoxuan/180724/TARDB28/",.meth,'/',"table/",sep = '')
...
pos <- grep("bacOTU_2$",rownames(sub_OTU))
