...
.botu <- paste0("~/xiaoxuan/180724/TARDB28/Usearch/table/AA/otutab_norm_AA.txt")
.fotu <- paste0("~/xiaoxuan/180724/TARDF16/Usearch/table/AA/otutab_norm_AA.txt")


#### Tax
# .btax <- paste0("~/xiaoxuan/180724/CoNet/",.meth,"/Tax/Tax.txt")
# .ftax <- paste0("~/xiaoxuan/180724/CoNet/",.meth,"/fTax/fTax.txt")
.btax <- paste0("~/xiaoxuan/180724/TARDB28/result/rep_seq_tax_bac.txt")
.ftax <- paste0("~/xiaoxuan/180724/TARDF16/result/taxonomy_8_match.txt")
...
# bac_aa <- (read.delim(.botu, row.names= 1,header=T, sep="\t",stringsAsFactors = F)-0.0001)/1000000 * 3.5*10000/3
# fungi_aa <- (read.delim(.fotu, row.names= 1,header=T, sep="\t",stringsAsFactors = F)-0.0001)/1000000 * 3.5*10000/3
...
fungi_tax <- read.delim(.ftax, row.names= 1,header=T, sep="\t",stringsAsFactors = F)
...
### to set col number unoise 300 usearch ncol
# .subflag=FALSE
.subflag==TRUE
if (.subflag==TRUE){
